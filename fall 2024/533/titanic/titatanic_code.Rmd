...
pca$rotation[, 1:3]
```
rotation tells me that Fare is important in three components as it places in all three, so it must be important.
SibSp places in two components, while Sex seems to be very influential in component three, so I will choose it.
